...
import { Button, Card, message, Input, Pagination, Slider, Tooltip, Empty, Upload, Spin, Switch } from 'antd';
...
function ShopPage() {
  ...
  const [priceRange, setPriceRange] = useState([0, 10000]); // Khoảng giá tìm kiếm
